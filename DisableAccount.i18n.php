...
این کاربر قادر به ورود به سامانه نخواهد بود، نمی‌تواند گذرواژه را تعویض کند و همچنین نمی‌تواند رایانامه دریافت کند. 
...
''Teña en conta que a desactivación dunha conta non é reversible sen a intervención dun administrador do sistema.''",
	...
	'logentry-block-disableaccount' => 'desactivou a conta de [[$1]].', # Fuzzy
);
...
''Vedite, da onemogočenja računa brez posredovanja sistemskega upravljavca ni mogoče razveljaviti.''",
	...
	'logentry-block-disableaccount' => 'je onemogočil(-a) račun [[$1]].', # Fuzzy
);
 ...
 */
$messages['tl'] = array(
	'disableaccount-desc' => 'Pahintulutan ang mga tagapangasiwa na huwag paganahin ang pang-isahang mga akawnt.',
